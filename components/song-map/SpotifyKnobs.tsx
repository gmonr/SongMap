...
/**
 * The Spotify transport's knob fragment: device picker (refreshes its
 * options whenever it's about to open), the not-synced warning, and the
 * calibrate toggle. Renders inside the TransportBar's knob row.
 */
  ...
  return (
    <>
      <select
        ...
        onMouseDown={() => sp.refreshDevices()}
        onFocus={() => sp.refreshDevices()}
